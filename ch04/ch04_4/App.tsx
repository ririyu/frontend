...
export default function App() {
  ...
  const onPress = useCallback((text) => () => setState(text), [])
...
const styles = StyleSheet.create({
  safeAreaView: {flex:1},
  topBar:{flexDirection:'row', flexWrap:'wrap', padding:5,
  justifyContent: 'space-between', backgroundColor:Colors.lightBlue500},
